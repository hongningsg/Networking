...
validators = {
    ('timeslots', 'POST'): {'args': {'required': ['body'], 'properties': {'body': {'type': 'string'}}}},
}

filters = {
    ('timeslots', 'GET'): {200: {'headers': None, 'schema': None}},
    ('timeslots', 'POST'): {200: {'headers': None, 'schema': None}},
    ('timeslots_id_reserve', 'GET'): {200: {'headers': None, 'schema': None}},
}
